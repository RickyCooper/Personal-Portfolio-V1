...
const svgBehance = (props) => {
    ...
    return (
        <a className={[...styleArray].join(' ')}  style={{"padding": "0"}} href="https://www.behance.net/rickycooper3/projects" target="_blank" rel="noopener noreferrer" style={{"overflow": "hidden"}}>
